...
* Fork the ``task_scheduler`` repo into your account.

* Obtain the source by cloning it onto your development machine.

  .. code-block:: console

      $ git clone git@github.com:your_name_here/task_scheduler.git
      $ cd task_scheduler
...
* Create and activate a Python virtual environment for local development. This
  ...
  .. note::
      ...
      (task_scheduler) is used to indicate when the commands
...
* Develop fix or enhancement:
  ...
  * The change should be style compliant. Perform style check.
    ...
    .. code-block:: console
        ...
        (task_scheduler) $ make check-style
